...
async function initializeDatabase() {
    const sql = `
        ...
        CREATE TABLE IF NOT EXISTS room_participants (room_id VARCHAR(50), user_id VARCHAR(50), is_host BOOLEAN DEFAULT false, purse_balance BIGINT DEFAULT 1200000000, PRIMARY KEY (room_id, user_id));
